  ...
  <div>
    <div class="form-row">
      <div class="col">
        ...
        <input type="text" id="txt_profesion" name="txt_profesion" aria-describedby="ayuda_profesion" class="form-control" v-model="formData.profecion" placeholder="Profesión">
    ...
    async obtenerDatos(){
      try{
        ...
        this.calcular_edad();
         ...
         console.log('ERROR OBTENIDO DE LOS DATOS',error);
      } 
    },
    calcular_edad(){
      const ahora = new Date();
      const objetNacimiento = new Date(this.formData.fechadenacimiento);

      let anios = ahora.getFullYear() - objetNacimiento.getFullYear();
      let meses = ahora.getMonth() - objetNacimiento.getMonth();
      let dias = ahora.getDate()-objetNacimiento.getDate();
      ...
      this.formdata.edad_dias;
    }
  },
  mounted(){
    //opcionalmente  se obtine los datos cuando el componete es creado,sin necesidad de precionar el botón
    //this.ontenerDatos();
